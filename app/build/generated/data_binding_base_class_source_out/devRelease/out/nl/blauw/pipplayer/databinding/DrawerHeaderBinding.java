...
public final class DrawerHeaderBinding implements ViewBinding {
  ...
  private DrawerHeaderBinding(@NonNull LinearLayout rootView, @NonNull TextView headerTitle) {
  ...
  public static DrawerHeaderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DrawerHeaderBinding((LinearLayout) rootView, headerTitle);
    }
