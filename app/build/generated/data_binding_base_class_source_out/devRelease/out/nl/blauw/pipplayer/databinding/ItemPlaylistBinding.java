...
public final class ItemPlaylistBinding implements ViewBinding {
  ...
  private ItemPlaylistBinding(@NonNull LinearLayout rootView, @NonNull ImageButton btnMore,
      @NonNull ImageView ivThumb, @NonNull TextView tvName, @NonNull TextView tvSubtext) {
  ...
  public static ItemPlaylistBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemPlaylistBinding((LinearLayout) rootView, btnMore, ivThumb, tvName, tvSubtext);
    }
