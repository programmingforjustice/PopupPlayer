...
public final class ActivityPlaylistBinding implements ViewBinding {
  ...
  private ActivityPlaylistBinding(@NonNull LinearLayout rootView, @NonNull ImageButton btnBack,
      @NonNull LinearLayout btnNewPlaylist, @NonNull LinearLayout layoutEmpty,
  ...
  public static ActivityPlaylistBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityPlaylistBinding((LinearLayout) rootView, btnBack, btnNewPlaylist,
          layoutEmpty, rvPlaylists);
    }
