...
public final class AppDatabase_Impl extends AppDatabase {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS `playlist_items` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `playlistId` INTEGER NOT NULL, `mediaPath` TEXT NOT NULL, `addedAt` INTEGER NOT NULL, FOREIGN KEY(`playlistId`) REFERENCES `playlists`(`id`) ON UPDATE NO ACTION ON DELETE CASCADE )");
        db.execSQL("CREATE INDEX IF NOT EXISTS `index_playlist_items_playlistId` ON `playlist_items` (`playlistId`)");
        db.execSQL("CREATE UNIQUE INDEX IF NOT EXISTS `index_playlist_items_playlistId_mediaPath` ON `playlist_items` (`playlistId`, `mediaPath`)");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'a266b06dcdb407745cbca3676ec27538')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        if (!_infoPlaylists.equals(_existingPlaylists)) {
          return new RoomOpenHelper.ValidationResult(false, "playlists(nl.blauw.pipplayer.Playlist).\n"
                  + " Expected:\n" + _infoPlaylists + "\n"
                  + " Found:\n" + _existingPlaylists);
        }
        final HashMap<String, TableInfo.Column> _columnsPlaylistItems = new HashMap<String, TableInfo.Column>(4);
        ...
        _columnsPlaylistItems.put("mediaPath", new TableInfo.Column("mediaPath", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsPlaylistItems.put("addedAt", new TableInfo.Column("addedAt", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        final HashSet<TableInfo.ForeignKey> _foreignKeysPlaylistItems = new HashSet<TableInfo.ForeignKey>(1);
        _foreignKeysPlaylistItems.add(new TableInfo.ForeignKey("playlists", "CASCADE", "NO ACTION", Arrays.asList("playlistId"), Arrays.asList("id")));
        final HashSet<TableInfo.Index> _indicesPlaylistItems = new HashSet<TableInfo.Index>(2);
        _indicesPlaylistItems.add(new TableInfo.Index("index_playlist_items_playlistId", false, Arrays.asList("playlistId"), Arrays.asList("ASC")));
        _indicesPlaylistItems.add(new TableInfo.Index("index_playlist_items_playlistId_mediaPath", true, Arrays.asList("playlistId", "mediaPath"), Arrays.asList("ASC", "ASC")));
        ...
        if (!_infoPlaylistItems.equals(_existingPlaylistItems)) {
          return new RoomOpenHelper.ValidationResult(false, "playlist_items(nl.blauw.pipplayer.PlaylistItem).\n"
                  + " Expected:\n" + _infoPlaylistItems + "\n"
                  + " Found:\n" + _existingPlaylistItems);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "a266b06dcdb407745cbca3676ec27538", "cde2861d53531ff4b97a524a84c822f3");
  ...
  protected InvalidationTracker createInvalidationTracker() {
    ...
    return new InvalidationTracker(this, _shadowTablesMap, _viewTables, "playlists","playlist_items");
  }
